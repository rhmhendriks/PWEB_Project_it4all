    ...
    <div id="addcompany_form">
		<form method="post" action="../process/process_AddCompany.php">
			...
			<div id="inputaddcompany">
				...
				<label>Description<span class="redStar">*</span></label>			<textarea id="description" rows="4" cols="150" maxlength="200" placeholder="Give a description of the new company" required=""></textarea>
			</div>
