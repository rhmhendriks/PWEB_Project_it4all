...
<div id="tiptrick_form">
	<form method="post" action="../_php/formulieren/process_NewTipTrick.php" enctype="multipart/form-data">
			...
			<div id="tiptrickgegevens">
				...
				<label>Auteur<span class="redStar">*</span></label>					<?php $resultoffunction=MySqlDo_DropDown('FirstName', 'Authors', 'Authorname'); echo $resultoffunction['optionfield']; ?>
				<label>Categorie<span class="redStar">*</span><label>				<?php $resultoffunction=MySqlDo_DropDown('CategoryTitle', 'TipsTricksCategory', 'categorie'); echo $resultoffunction['optionfield']; ?>
