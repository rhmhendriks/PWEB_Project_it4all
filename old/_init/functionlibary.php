                ...
                function MySqlDo_Overview($table=null, $columns, $idColumn, $other=null){
                    ...
                    if ($statementrunned->num_rows > 0) {
                        ...
                        foreach ($resultaat as $rij){
                            ...
                            $returntable .= '<a href="https://www.w3schools.com"><img border="0" alt="edit" src="../_images/edit.png"></a><a href="https://www.w3schools.com"><img border="0" alt="edit" src="../_images/delete.png"></a>';
                            $returntable .= '</td></tr>';
                        }
