...
<body>
    ...
    <footer>
        ...
        <br>
        <div> <a href="index.php?inc=y&page=statements&statement=cookie">Cookie's</a> &nbsp;&nbsp;&nbsp; <a href="index.php?inc=y&page=statements&statement=privacy">Privacy</a> &nbsp;&nbsp;&nbsp; <a href="index.php?inc=y&page=statements&statement=disclaimer">Disclaimer</a> &nbsp;&nbsp;&nbsp; <a href="index.php?inc=y&page=statements&statement=voorwaarden">Algemene Voorwaarden</a> </div>
